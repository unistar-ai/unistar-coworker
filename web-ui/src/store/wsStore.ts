...
export const useStore = create<Store>((set) => ({
  ...
  applyChatPatch: (p) =>
    set((state) => ({
      ...
      chat_line_times: p.chat_line_times ?? {},
      chat_assistant_ids: p.chat_assistant_ids,
      chat_history_revision: p.chat_history_revision,
      chat_turn_parts: p.chat_turn_parts ?? null,
      chat_history_turn_parts: p.chat_history_turn_parts ?? {},
      chat_older_available: p.chat_older_available,
      chat_lines_truncated: p.chat_lines_truncated ?? false,
      chat_older_in_store: p.chat_older_in_store ?? false,
  ...
  applyWsMessage: (m) => {
    if (isSnapshot(m)) {
      ...
      set((state) => ({
        ...
        chat_reasoning_originals: m.chat_reasoning_originals,
        chat_line_times: m.chat_line_times ?? {},
        chat_assistant_ids: m.chat_assistant_ids,
        chat_history_revision: m.chat_history_revision,
        chat_turn_parts: m.chat_turn_parts ?? null,
        chat_history_turn_parts: m.chat_history_turn_parts ?? {},
        chat_older_available: m.chat_older_available,
        chat_lines_truncated: m.chat_lines_truncated ?? false,
        chat_older_in_store: m.chat_older_in_store ?? false,
