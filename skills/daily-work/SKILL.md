...
3. Classify **flaky vs real vs policy** page-by-page; policy gates (approvals, changelog, templates) are **not** needs-attention engineering work.
4. Emit a detailed per-PR summary; the digest splits runs into **Needs attention**, **Flaky**, and **Policy gates** by verdict.
